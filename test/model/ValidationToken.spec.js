...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HlConnect.ValidationToken();
  });
  ...
  describe('ValidationToken', function() {
    it('should create an instance of ValidationToken', function() {
      // uncomment below and update the code to test ValidationToken
      //var instance = new HlConnect.ValidationToken();
      //expect(instance).to.be.a(HlConnect.ValidationToken);
    });
