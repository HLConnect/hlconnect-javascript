...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HlConnector.PurchaseRegisterRequest();
  });
  ...
  describe('PurchaseRegisterRequest', function() {
    it('should create an instance of PurchaseRegisterRequest', function() {
      // uncomment below and update the code to test PurchaseRegisterRequest
      //var instance = new HlConnector.PurchaseRegisterRequest();
      //expect(instance).to.be.a(HlConnector.PurchaseRegisterRequest);
    });
