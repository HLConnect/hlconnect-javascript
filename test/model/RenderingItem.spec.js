...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HlConnector.RenderingItem();
  });
  ...
  describe('RenderingItem', function() {
    it('should create an instance of RenderingItem', function() {
      // uncomment below and update the code to test RenderingItem
      //var instance = new HlConnector.RenderingItem();
      //expect(instance).to.be.a(HlConnector.RenderingItem);
    });
