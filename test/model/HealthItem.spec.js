...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HlConnector.HealthItem();
  });
  ...
  describe('HealthItem', function() {
    it('should create an instance of HealthItem', function() {
      // uncomment below and update the code to test HealthItem
      //var instance = new HlConnector.HealthItem();
      //expect(instance).to.be.a(HlConnector.HealthItem);
    });
