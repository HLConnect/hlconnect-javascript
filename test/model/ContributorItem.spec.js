...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HlConnector.ContributorItem();
  });
  ...
  describe('ContributorItem', function() {
    it('should create an instance of ContributorItem', function() {
      // uncomment below and update the code to test ContributorItem
      //var instance = new HlConnector.ContributorItem();
      //expect(instance).to.be.a(HlConnector.ContributorItem);
    });
