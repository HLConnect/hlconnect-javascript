...
class ViewUrl {
    ...
    /**
     * Validates the JSON data with respect to <code>ViewUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ViewUrl</code>.
     */
...
/**
 * Secure, time-limited URL that can be used to view the purchased digital asset online. The URL expires after a predetermined period.
 * @member {String} url
 */
ViewUrl.prototype['url'] = undefined;
